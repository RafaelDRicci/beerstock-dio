...
public class BeerServiceTest {
    ...
    @Test
    void whenAlreadyRegistredBeerInformatedThenAnExceptionSouldBeThrown() {
        //given
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenExclusionIsCalledWithValidIdThenABeerSouldBeDeleted() throws BeerNotFoundException {
        //given
    ...
    @Test
    void whenIncrementIsGreatedThanMaxThenThrowException() throws BeerNotFoundException {
        //given
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        Beer expectedBeer = beerMapper.toModel(expectedBeerDTO);
    ...
    @Test
    void whenIncrementAfterSumIsGreatedThanMaxThenThrowException() throws BeerNotFoundException {
        //given
        BeerDTO expectedBeerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        Beer expectedBeer = beerMapper.toModel(expectedBeerDTO);
